%% gen traj
Tmax = 5
[q1d,q1v,q1a] = GenTraj(0,1.047,0,Tmax);
[q2d,q2v,q2a] = GenTraj(0,-1.047,0,Tmax);
[q3d,q3v,q3a] = GenTraj(0,1.047,0,Tmax);
[q4d,q4v,q4a] = GenTraj(0,-1.047,0,Tmax);
[q5d,q5v,q5a] = GenTraj(0,1.047,0,Tmax);
[q6d,q6v,q6a] = GenTraj(0,1.047,0,Tmax);
